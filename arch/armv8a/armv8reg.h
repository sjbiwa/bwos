...
#define CSSELR_EL1_set(v)							__asm__ volatile ("MSR CSSELR_EL1, %0"::"r"((uint64_t)(v)):"memory")
...
#define VMPIDR_EL2_set(v)							__asm__ volatile ("MSR VMPIDR_EL2, %0"::"r"((uint64_t)(v)):"memory")
#define VPIDR_EL2_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, VPIDR_EL2":"=r"(_reg_)::"memory");_reg_;})
#define VPIDR_EL2_set(v)							__asm__ volatile ("MSR VPIDR_EL2, %0"::"r"((uint64_t)(v)):"memory")
#define PMCCFILTR_EL0_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, PMCCFILTR_EL0":"=r"(_reg_)::"memory");_reg_;})
#define PMCCFILTR_EL0_set(v)						__asm__ volatile ("MSR PMCCFILTR_EL0, %0"::"r"((uint64_t)(v)):"memory")
#define PMCCNTR_EL0_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, PMCCNTR_EL0":"=r"(_reg_)::"memory");_reg_;})
#define PMCCNTR_EL0_set(v)							__asm__ volatile ("MSR PMCCNTR_EL0, %0"::"r"((uint64_t)(v)):"memory")
...
#define MDCR_EL2_set(v)								__asm__ volatile ("MSR MDCR_EL2, %0"::"r"((uint64_t)(v)):"memory")
#define MDCR_EL3_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, MDCR_EL3":"=r"(_reg_)::"memory");_reg_;})
#define MDCR_EL3_set(v)								__asm__ volatile ("MSR MDCR_EL3, %0"::"r"((uint64_t)(v)):"memory")
...
#define MDSCR_EL1_set(v)							__asm__ volatile ("MSR MDSCR_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define OSDLR_EL1_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, OSDLR_EL1":"=r"(_reg_)::"memory");_reg_;})
#define OSDLR_EL1_set(v)							__asm__ volatile ("MSR OSDLR_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define OSDTRRX_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, OSDTRRX_EL1":"=r"(_reg_)::"memory");_reg_;})
#define OSDTRRX_EL1_set(v)							__asm__ volatile ("MSR OSDTRRX_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define OSDTRTX_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, OSDTRTX_EL1":"=r"(_reg_)::"memory");_reg_;})
#define OSDTRTX_EL1_set(v)							__asm__ volatile ("MSR OSDTRTX_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define OSECCR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, OSECCR_EL1":"=r"(_reg_)::"memory");_reg_;})
#define OSECCR_EL1_set(v)							__asm__ volatile ("MSR OSECCR_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define OSLAR_EL1_set(v)							__asm__ volatile ("MSR OSLAR_EL1, %0"::"r"((uint64_t)(v)):"memory")
...
#define CNTPS_CTL_EL1_set(v)						__asm__ volatile ("MSR CNTPS_CTL_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define CNTPS_CVAL_EL1_get()						({uint64_t _reg_;__asm__ volatile ("MRS %0, CNTPS_CVAL_EL1":"=r"(_reg_)::"memory");_reg_;})
#define CNTPS_CVAL_EL1_set(v)						__asm__ volatile ("MSR CNTPS_CVAL_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define CNTPS_TVAL_EL1_get()						({uint64_t _reg_;__asm__ volatile ("MRS %0, CNTPS_TVAL_EL1":"=r"(_reg_)::"memory");_reg_;})
#define CNTPS_TVAL_EL1_set(v)						__asm__ volatile ("MSR CNTPS_TVAL_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define CNTV_CTL_EL0_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, CNTV_CTL_EL0":"=r"(_reg_)::"memory");_reg_;})
#define CNTV_CTL_EL0_set(v)							__asm__ volatile ("MSR CNTV_CTL_EL0, %0"::"r"((uint64_t)(v)):"memory")
#define CNTV_CVAL_EL0_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, CNTV_CVAL_EL0":"=r"(_reg_)::"memory");_reg_;})
#define CNTV_CVAL_EL0_set(v)						__asm__ volatile ("MSR CNTV_CVAL_EL0, %0"::"r"((uint64_t)(v)):"memory")
#define CNTV_TVAL_EL0_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, CNTV_TVAL_EL0":"=r"(_reg_)::"memory");_reg_;})
#define CNTV_TVAL_EL0_set(v)						__asm__ volatile ("MSR CNTV_TVAL_EL0, %0"::"r"((uint64_t)(v)):"memory")
...
#define CNTVOFF_EL2_set(v)							__asm__ volatile ("MSR CNTVOFF_EL2, %0"::"r"((uint64_t)(v)):"memory")
#define DC_CISW_set(v)								__asm__ volatile ("DC CISW, %0"::"r"((uint64_t)(v)):"memory")
#define DC_CIVAC_set(v)								__asm__ volatile ("DC CIVAC, %0"::"r"((uint64_t)(v)):"memory")
#define DC_CSW_set(v)								__asm__ volatile ("DC CSW, %0"::"r"((uint64_t)(v)):"memory")
#define DC_CVAC_set(v)								__asm__ volatile ("DC CVAC, %0"::"r"((uint64_t)(v)):"memory")
#define DC_CVAU_set(v)								__asm__ volatile ("DC CVAU, %0"::"r"((uint64_t)(v)):"memory")
#define DC_ISW_set(v)								__asm__ volatile ("DC ISW, %0"::"r"((uint64_t)(v)):"memory")
#define DC_IVAC_set(v)								__asm__ volatile ("DC IVAC, %0"::"r"((uint64_t)(v)):"memory")
#define DC_ZVA_set(v)								__asm__ volatile ("DC ZVA, %0"::"r"((uint64_t)(v)):"memory")
#define IC_IALLU_set()								__asm__ volatile ("IC IALLU":::"memory")
#define IC_IALLUIS_set()							__asm__ volatile ("IC IALLUIS":::"memory")
#define AT_S12E0R_set(v)							__asm__ volatile ("AT S12E0R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S12E0W_set(v)							__asm__ volatile ("AT S12E0W, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S12E1R_set(v)							__asm__ volatile ("AT S12E1R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S12E1W_set(v)							__asm__ volatile ("AT S12E1W, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E0R_set(v)								__asm__ volatile ("AT S1E0R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E0W_set(v)								__asm__ volatile ("AT S1E0W, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E1R_set(v)								__asm__ volatile ("AT S1E1R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E1W_set(v)								__asm__ volatile ("AT S1E1W, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E2R_set(v)								__asm__ volatile ("AT S1E2R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E2W_set(v)								__asm__ volatile ("AT S1E2W, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E3R_set(v)								__asm__ volatile ("AT S1E3R, %0"::"r"((uint64_t)(v)):"memory")
#define AT_S1E3W_set(v)								__asm__ volatile ("AT S1E3W, %0"::"r"((uint64_t)(v)):"memory")
...
#define TLBI_ASIDE1_set(v)							__asm__ volatile ("TLBI ASIDE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_ASIDE1IS_set(v)						__asm__ volatile ("TLBI ASIDE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_IPAS2E1_set(v)							__asm__ volatile ("TLBI IPAS2E1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_IPAS2E1IS_set(v)						__asm__ volatile ("TLBI IPAS2E1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_IPAS2LE1_set(v)						__asm__ volatile ("TLBI IPAS2LE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_IPAS2LE1IS_set(v)						__asm__ volatile ("TLBI IPAS2LE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAAE1_set(v)							__asm__ volatile ("TLBI VAAE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAAE1IS_set(v)							__asm__ volatile ("TLBI VAAE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAALE1_set(v)							__asm__ volatile ("TLBI VAALE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAALE1IS_set(v)						__asm__ volatile ("TLBI VAALE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE1_set(v)							__asm__ volatile ("TLBI VAE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE1IS_set(v)							__asm__ volatile ("TLBI VAE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE2_set(v)							__asm__ volatile ("TLBI VAE2, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE2IS_set(v)							__asm__ volatile ("TLBI VAE2IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE3_set(v)							__asm__ volatile ("TLBI VAE3, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VAE3IS_set(v)							__asm__ volatile ("TLBI VAE3IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE1_set(v)							__asm__ volatile ("TLBI VALE1, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE1IS_set(v)							__asm__ volatile ("TLBI VALE1IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE2_set(v)							__asm__ volatile ("TLBI VALE2, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE2IS_set(v)							__asm__ volatile ("TLBI VALE2IS, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE3_set(v)							__asm__ volatile ("TLBI VALE3, %0"::"r"((uint64_t)(v)):"memory")
#define TLBI_VALE3IS_set(v)							__asm__ volatile ("TLBI VALE3IS, %0"::"r"((uint64_t)(v)):"memory")
...
#define NZCV_set(v)									__asm__ volatile ("MSR NZCV, %0"::"r"((uint64_t)(v)):"memory")
#define PAR_EL1_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, PAR_EL1":"=r"(_reg_)::"memory");_reg_;})
#define PAR_EL1_set(v)								__asm__ volatile ("MSR PAR_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define RMR_EL1_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, RMR_EL1":"=r"(_reg_)::"memory");_reg_;})
#define RMR_EL1_set(v)								__asm__ volatile ("MSR RMR_EL1, %0"::"r"((uint64_t)(v)):"memory")
#define RMR_EL2_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, RMR_EL2":"=r"(_reg_)::"memory");_reg_;})
#define RMR_EL2_set(v)								__asm__ volatile ("MSR RMR_EL2, %0"::"r"((uint64_t)(v)):"memory")
#define RMR_EL3_get()								({uint64_t _reg_;__asm__ volatile ("MRS %0, RMR_EL3":"=r"(_reg_)::"memory");_reg_;})
#define RMR_EL3_set(v)								__asm__ volatile ("MSR RMR_EL3, %0"::"r"((uint64_t)(v)):"memory")
...
#define L2CTLR_EL1_set(v)							__asm__ volatile ("MSR S3_1_C11_C0_2, %0"::"r"((uint64_t)(v)):"memory")
#define L2ECTLR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, S3_1_C11_C0_3":"=r"(_reg_)::"memory");_reg_;})
#define L2ECTLR_EL1_set(v)							__asm__ volatile ("MSR S3_1_C11_C0_3, %0"::"r"((uint64_t)(v)):"memory")
#define L2ACTLR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, S3_1_C15_C0_0":"=r"(_reg_)::"memory");_reg_;})
#define L2ACTLR_EL1_set(v)							__asm__ volatile ("MSR S3_1_C15_C0_0, %0"::"r"((uint64_t)(v)):"memory")
#define CPUACTLR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, S3_1_C15_C2_0":"=r"(_reg_)::"memory");_reg_;})
#define CPUACTLR_EL1_set(v)							__asm__ volatile ("MSR S3_1_C15_C2_0, %0"::"r"((uint64_t)(v)):"memory")
#define CPUECTLR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, S3_1_C15_C2_1":"=r"(_reg_)::"memory");_reg_;})
#define CPUECTLR_EL1_set(v)							__asm__ volatile ("MSR S3_1_C15_C2_1, %0"::"r"((uint64_t)(v)):"memory")
#define CPUMERRSR_EL1_get()							({uint64_t _reg_;__asm__ volatile ("MRS %0, S3_1_c15_c2_2":"=r"(_reg_)::"memory");_reg_;})
#define CPUMERRSR_EL1_set(v)						__asm__ volatile ("MSR S3_1_c15_c2_2, %0"::"r"((uint64_t)(v)):"memory")
