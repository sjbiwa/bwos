...
#define ICC_AP0R1_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C8_5, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 0 Registers, n = 0 - 3 */
...
#define ICC_AP0R2_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C8_6, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 0 Registers, n = 0 - 3 */
...
#define ICC_AP0R3_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C8_7, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 0 Registers, n = 0 - 3 */
...
#define ICC_AP1R0_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C9_0, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 1 Registers, n = 0 - 3 */
...
#define ICC_AP1R1_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C9_1, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 1 Registers, n = 0 - 3 */
...
#define ICC_AP1R2_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C9_2, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 1 Registers, n = 0 - 3 */
...
#define ICC_AP1R3_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C9_3, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Active Priorities Group 1 Registers, n = 0 - 3 */
#define ICC_ASGI1R_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C11_6, %0"::"r"((uint64_t)(v)):"memory")						/* WO Interrupt Controller Alias Software Generated Interrupt Group 1 Register */
...
#define ICC_BPR0_EL1_set(v)			__asm__ volatile ("MSR S3_0_C12_C8_3, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Binary Point Register 0 */
...
#define ICC_BPR1_EL1_set(v)			__asm__ volatile ("MSR S3_0_C12_C8_3, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Binary Point Register 1 */
...
#define ICC_CTLR_EL1_set(v)			__asm__ volatile ("MSR S3_0_C12_C12_4, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller Control Register (EL1) */
...
#define ICC_CTLR_EL3_set(v)			__asm__ volatile ("MSR S3_6_C12_C12_4, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller Control Register (EL3) */
#define ICC_DIR_EL1_set(v)			__asm__ volatile ("MSR S3_0_C12_C11_1, %0"::"r"((uint64_t)(v)):"memory")						/* WO Interrupt Controller Deactivate Interrupt Register */
#define ICC_EOIR0_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C8_1, %0"::"r"((uint64_t)(v)):"memory")							/* WO Interrupt Controller End Of Interrupt Register 0 */
#define ICC_EOIR1_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C12_1, %0"::"r"((uint64_t)(v)):"memory")						/* WO Interrupt Controller End Of Interrupt Register 1 */
...
#define ICC_IGRPEN0_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C12_6, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller Interrupt Group 0 Enable register */
...
#define ICC_IGRPEN1_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C12_7, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller Interrupt Group 1 Enable register */
...
#define ICC_IGRPEN1_EL3_set(v)		__asm__ volatile ("MSR S3_6_C12_C12_7, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller Interrupt Group 1 Enable register (EL3) */
...
#define ICC_PMR_EL1_set(v)			__asm__ volatile ("MSR S3_0_C4_C6_0, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller Interrupt Priority Mask Register */
...
#define ICC_SGI0R_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C11_7, %0"::"r"((uint64_t)(v)):"memory")						/* WO Interrupt Controller Software Generated Interrupt Group 0 Register */
#define ICC_SGI1R_EL1_set(v)		__asm__ volatile ("MSR S3_0_C12_C11_5, %0"::"r"((uint64_t)(v)):"memory")						/* WO Interrupt Controller Software Generated Interrupt Group 1 Register */
...
#define ICC_SRE_EL1_set(v)			__asm__ volatile ("MSR S3_0_C12_C12_5, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller System Register Enable register (EL1) */
...
#define ICC_SRE_EL2_set(v)			__asm__ volatile ("MSR S3_4_C12_C9_5, %0"::"r"((uint64_t)(v)):"memory")							/* RW Interrupt Controller System Register Enable register (EL2) */
...
#define ICC_SRE_EL3_set(v)			__asm__ volatile ("MSR S3_6_C12_C12_5, %0"::"r"((uint64_t)(v)):"memory")						/* RW Interrupt Controller System Register Enable register (EL3) */
